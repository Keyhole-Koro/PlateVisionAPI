...
app.post('/upload', upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    res.send({ message: 'Image uploaded and processed successfully', result: response.data.result, image: response.data.image, execution_time: response.data.execution_time });
  } catch (error) {
